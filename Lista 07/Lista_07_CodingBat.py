...
def array_count9(nums):
    ...
    # desnecessario no exercicio, porem, caso necessitasse preservar nums
    # x = nums

    i = 0

    while 9 in nums:
        nums.pop( nums.index(9) )
        i += 1
...
def sem_pontas(s):
    ...
    #verificacao de tamanho opcional
    #retira o primeiro caractere
    s = s[1::]
    #retira o ultimo
    s = s[ :len(s)-1: ]
